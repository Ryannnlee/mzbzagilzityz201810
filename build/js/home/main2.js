...
$(function () {
    ...
    var tween3 = new TimelineMax().add([TweenMax.fromTo("#txtHead3", 1, {
        y: 100,
        top: 0,
        opacity: 0
    }, {
...
$(function () {
    ...
    if (screenw < 992) {
        ...
        superscroll.addTween('#section4', new TimelineLite().append([TweenMax.fromTo($('#advantage-title'), .5, {
            y: '50%',
            opacity: 0,
            immediateRender: true
        }, {
